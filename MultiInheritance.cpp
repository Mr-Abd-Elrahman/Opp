...
public:
    clsDeveloper(int ID, std::string FirstName, std::string LastName, std::string Email, std::string Phone,
                 float salary, std::string Title, std::string Department, std::string ProgLang)
        : clsEmployee(ID, FirstName, LastName, Email, Phone, salary, Title, Department)
    {
        _MainProgrammingLanguage = ProgLang;
    }

    void SetProgrammingLanguage(std::string Lang)
    {
    ...
    void Print()
    {
        ...
        std::cout << "\nEmail                : " << GetEmail();
        std::cout << "\nPhone                : " << GetPhone();
        // sub class Employee (in the time it consider a base class for clsDeveloper) private data members
        std::cout << "\nTitel                : " << GetTitle();
        std::cout << "\nDepartment           : " << GetDepartment();
        std::cout << "\nSalary               : " << GetSalary();
        // sub class developer private members
...
int main()
{
    clsDeveloper Developer1(10, "Ahmed", "Mohammed", "Ahmed@gmail.com", "023434543456", 2344, "Manager", "It", "C++");
    Developer1.Print();
    Developer1.SendEmail("Hi", "How are you?");
    Developer1.SendSMS("I will be waiting for you :_)");
